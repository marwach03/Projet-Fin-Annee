...
const PodcastsAcceuil = () => {
  const navigation = useNavigation();

  const handlePositivity = () => {
    navigation.navigate('PositivityPodcast');
  };

  const handleNeverGiveUp = () => {
    ...
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <View style={styles.container}>
        ...
        <View style={styles.bigcontainer}>
          ...
          <Video
            source={require('../../../assets/back11.mp4')}
            rate={1.0}
            resizeMode="cover"
            shouldPlay
            isMuted={true}
          ...
          />
            ...
            <View>
              <Text style={styles.usernameS}>{username || 'Guest'}, are you ready to listen to podcasts</Text>
...
export default PodcastsAcceuil;
